...
<head>
    ...
    <title>Coverage for /workspace/enki/venv/lib/python3.8/site-packages/cnxml/util.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/enki/venv/lib/python3.8/site-packages/cnxml/util.py</b> :
...
<div id="source">
    ...
    <p id="t8" class="pln"><span class="n"><a href="#t8">8</a></span><span class="t">    <span class="str">'lookup_resource'</span><span class="op">,</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t12" class="run"><span class="n"><a href="#t12">12</a></span><span class="t"><span class="key">def</span> <span class="nam">lookup_resource</span><span class="op">(</span><span class="nam">resource_path</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t13" class="run"><span class="n"><a href="#t13">13</a></span><span class="t">    <span class="key">return</span> <span class="nam">Path</span><span class="op">(</span><span class="nam">pkg_resources</span><span class="op">.</span><span class="nam">resource_filename</span><span class="op">(</span><span class="str">'cnxml'</span><span class="op">,</span> <span class="nam">resource_path</span><span class="op">)</span><span class="op">)</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
