...
<head>
    ...
    <title>Coverage for /workspace/enki/venv/lib/python3.8/site-packages/litezip/exceptions.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/workspace/enki/venv/lib/python3.8/site-packages/litezip/exceptions.py</b> :
...
<div id="source">
    ...
    <p id="t5" class="pln"><span class="n"><a href="#t5">5</a></span><span class="t">    <span class="str">'MissingFile'</span><span class="op">,</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t9" class="run"><span class="n"><a href="#t9">9</a></span><span class="t"><span class="key">class</span> <span class="nam">MissingFile</span><span class="op">(</span><span class="nam">Exception</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t10" class="pln"><span class="n"><a href="#t10">10</a></span><span class="t">    <span class="str">"""Used when the `collection.xml` or `index.cnxml` file is missing."""</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
